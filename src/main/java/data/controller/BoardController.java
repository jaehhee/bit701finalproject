...
public class BoardController {
	...
	// 버켓 이름 지정
	private String bucketName="bit701-bucket-92";
	...
	@PostMapping("/insert")
	public void isnert(@RequestBody BoardDto dto)
	{
	...
	public BoardDto detailPage(int num)
	{
		...
		return boardService.deltailPage(num);
	}
	...
	public void delete(int num)
	{
		...
		String prePhoto = boardService.deltailPage(num).getPhoto();
